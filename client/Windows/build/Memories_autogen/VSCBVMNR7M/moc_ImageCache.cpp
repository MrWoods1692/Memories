...
struct qt_meta_stringdata_CLASSImageCacheENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSImageCacheENDCLASS = QtMocHelpers::stringData(
    "ImageCache",
    "cacheCleared",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSImageCacheENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ImageCache::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSImageCacheENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSImageCacheENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSImageCacheENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void ImageCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ImageCache::cacheCleared; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ImageCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSImageCacheENDCLASS.stringdata0))
