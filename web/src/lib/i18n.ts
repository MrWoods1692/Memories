...
const zh: Translation = {
  ...
  aboutPage: {
    ...
    costs: [
      ...
      { label: '公网费用', amount: '¥120' },
      { label: '其他费用', amount: '¥100' },
    ],
    techStackTitle: '技术栈',
    techStack: [
      { category: 'Android', items: ['Java', 'Android SDK', 'NanoHTTPD', 'OkHttp', 'SQLite', 'WorkManager', 'frp'] },
      { category: '官网', items: ['React 18', 'TypeScript', 'Vite', 'Tailwind CSS', 'shadcn/ui', 'Motion', 'Supabase', 'react-router', 'lucide-react'] },
      { category: '管理面板', items: ['React 19', 'TypeScript', 'Vite', 'oxlint'] },
      { category: '文档站', items: ['Vue 3', 'Vite', 'Vue Router'] },
      { category: 'Windows 客户端', items: ['Qt 6', 'C++20', 'CMake'] },
      { category: '工具链', items: ['pnpm', 'npm', 'Gradle', 'Biome', 'PostCSS'] },
    ],
...
const en: Translation = {
  ...
  aboutPage: {
    ...
    costs: [
      ...
      { label: 'Public Network Fee', amount: '¥120' },
      { label: 'Other Costs', amount: '¥100' },
    ],
    techStackTitle: 'Tech Stack',
    techStack: [
      { category: 'Android', items: ['Java', 'Android SDK', 'NanoHTTPD', 'OkHttp', 'SQLite', 'WorkManager', 'frp'] },
      { category: 'Website', items: ['React 18', 'TypeScript', 'Vite', 'Tailwind CSS', 'shadcn/ui', 'Motion', 'Supabase', 'react-router', 'lucide-react'] },
      { category: 'Admin Panel', items: ['React 19', 'TypeScript', 'Vite', 'oxlint'] },
      { category: 'API Docs', items: ['Vue 3', 'Vite', 'Vue Router'] },
      { category: 'Windows Client', items: ['Qt 6', 'C++20', 'CMake'] },
      { category: 'Toolchain', items: ['pnpm', 'npm', 'Gradle', 'Biome', 'PostCSS'] },
    ],
...
const zhTW: Translation = {
  ...
  aboutPage: {
    ...
    costs: [
      ...
      { label: '公網費用', amount: '¥120' },
      { label: '其他費用', amount: '¥100' },
    ],
    techStackTitle: '技術棧',
    techStack: [
      { category: 'Android', items: ['Java', 'Android SDK', 'NanoHTTPD', 'OkHttp', 'SQLite', 'WorkManager', 'frp'] },
      { category: '官網', items: ['React 18', 'TypeScript', 'Vite', 'Tailwind CSS', 'shadcn/ui', 'Motion', 'Supabase', 'react-router', 'lucide-react'] },
      { category: '管理面板', items: ['React 19', 'TypeScript', 'Vite', 'oxlint'] },
      { category: '文檔站', items: ['Vue 3', 'Vite', 'Vue Router'] },
      { category: 'Windows 客戶端', items: ['Qt 6', 'C++20', 'CMake'] },
      { category: '工具鏈', items: ['pnpm', 'npm', 'Gradle', 'Biome', 'PostCSS'] },
    ],
...
const ja: Translation = {
  ...
  aboutPage: {
    ...
    costs: [
      ...
      { label: '公網費用', amount: '¥120' },
      { label: 'その他費用', amount: '¥100' },
    ],
    techStackTitle: '技術スタック',
    techStack: [
      { category: 'Android', items: ['Java', 'Android SDK', 'NanoHTTPD', 'OkHttp', 'SQLite', 'WorkManager', 'frp'] },
      { category: 'Webサイト', items: ['React 18', 'TypeScript', 'Vite', 'Tailwind CSS', 'shadcn/ui', 'Motion', 'Supabase', 'react-router', 'lucide-react'] },
      { category: '管理パネル', items: ['React 19', 'TypeScript', 'Vite', 'oxlint'] },
      { category: 'ドキュメント', items: ['Vue 3', 'Vite', 'Vue Router'] },
      { category: 'Windows クライアント', items: ['Qt 6', 'C++20', 'CMake'] },
      { category: 'ツールチェーン', items: ['pnpm', 'npm', 'Gradle', 'Biome', 'PostCSS'] },
    ],
